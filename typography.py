...
text = {
    ...
    'legend': 'The orange line is an APR you can expect on average, considering the growth of total active validators number. Blue dots are simulations of possible deviation from the average due to the random amount of block proposals per validator, and random distribution of execution rewards (including MEV).'
}